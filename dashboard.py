...
# Page configuration
st.set_page_config(
    page_title="Francis Scott Key Bridge Vessel Monitor",
    page_icon="🚢",
    layout="wide"
)
...
with title_col:
    st.title("🌉 Francis Scott Key Bridge Vessel Collision Monitoring System")
...
with col1:
    ...
    folium.Marker(
        ...
        popup="Francis Scott Key Bridge",
        tooltip="Francis Scott Key Bridge",
...
with col2:
    ...
    with st.expander("View Details", expanded=False):
        ...
        • **Year Built:** 1977
        • **Year Collapsed:** March 26, 2024
        • **Owner:** Maryland Transportation Authority
        • **Bridge Type:** Continuous truss bridge
        """)
        
        st.markdown("### Physical Characteristics")
        st.markdown("""
        • **Main Span Length:** 1,200 feet
        • **Total Bridge Length:** 8,636 feet (1.6 miles)
        • **Deck Width:** [TBD] feet
        • **Roadway Width:** [TBD] feet
        • **Vertical Clearance:** 185 feet MHW
        • **Horizontal Clearance:** 1,200 feet (main span)
        • **Number of Spans:** 21
        """)
        ...
        • **Note:** This bridge collapsed on March 26, 2024 after being struck by the container ship Dali. This monitoring system demonstrates how such disasters could be prevented at other high-risk bridges.
        """)
    ...
    with st.expander("View Details", expanded=False):
        ...
        st.markdown("""
        • **Chart Reference:** NOAA Chart 12278 (Baltimore Harbor)
        • **Channel Width:** 700 feet (Brewerton Channel)
        • **Maintained Depth:** 50 feet MLW (Mean Low Water)
        • **Project Depth:** 50 feet
        • **Actual Depth Range:** 50-55 feet (varies by location)
        """)
        
        st.markdown("### Clearances")
        st.markdown("""
        • **Vertical Clearance:** 185 feet MHW (Mean High Water)
        • **Horizontal Clearance:** 1,200 feet (main span)
        """)
        ...
        st.markdown("""
        • **Annual Transits:** ~8,000 vessels (Port of Baltimore)
        • **Typical Vessels:** Container ships, bulk carriers, tankers, vehicle carriers, tugs/barges
        • **Speed Limit:** 6 knots (Baltimore Harbor regulation)
        • **VTS Coverage:** Coast Guard Sector Maryland-National Capital Region
        """)
        
        st.markdown("### Pier-Specific Data")
        st.markdown("""
        • **Number of Piers:** 10 (Piers 14-23)
        • **Main Span Piers:** Pier 17 and Pier 18
        • **Pier Locations:** See map for individual pier coordinates
